...
const SkeletoneAnswerCard = () => {
  return (
    <div>
      <div className="w-11/12 bg-stone-700 rounded-md p-4 mb-4 flex text-sm animate-pulse">
        ...
        <div className="flex flex-col bg-red-0 justify-between">
          ...
          <div className="w-40 h-4 bg-stone-600  rounded-md"></div>
          <div className="w-32 h-4 bg-stone-600  rounded-md"></div>
        </div>
      </div>
    </div>
  );
