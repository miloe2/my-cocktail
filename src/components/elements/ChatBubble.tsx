...
import { ChatGptMessage, ChatGptResponse, ChatUserMessage,  } from "@/types/types";
import AnswerCard from "@/components/elements/AnswerCard";

const ChatBubble = React.memo(({ chat } : {chat : ChatGptMessage | ChatUserMessage}) => {
